...
class AudioClip(BaseModel):
    ...
    track_id: Optional[str] = None  # Track this clip belongs to
    type: Optional[str] = None  # Type of clip (uploaded, recorded, etc.)
...
# Audio Upload Routes (consolidated)
...
async def upload_audio_file(
    ...
    try:
        ...
        clip_data = {
            ...
            "track_id": track_id,
            "type": "uploaded",  # Mark as uploaded clip
